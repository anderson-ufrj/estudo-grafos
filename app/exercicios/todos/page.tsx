        ...
        <main className="container-modern px-4 py-8">
          <div className="max-w-4xl mx-auto">
            <nav className="mb-8">
              ...
              <span className="text-gray-700">Exercícios</span>
              <span className="mx-2 text-gray-500">/</span>
              <span className="text-gray-900">Todos os Exercícios Resolvidos</span>
            </nav>

            <h1 className="text-4xl font-bold mb-4">Exercícios Resolvidos</h1>
            <p className="text-gray-600 mb-8">Questões selecionadas com resolução completa passo a passo</p>
              ...
              <section className="mb-12 print-break">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">Conjuntos</span>
                  </div>
              ...
              <section className="mb-12 print-break">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">Funções</span>
                  </div>
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="bg-white p-4 rounded-lg">
                          ...
                          <p className="text-sm mt-2 text-gray-600">ou equivalentemente:</p>
                      ...
                      <div>
                        ...
                        <div className="bg-white p-4 rounded-lg">
                          ...
                          <p className="text-sm text-gray-600 mt-3">Todas as imagens são distintas ✓</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <section className="mb-12 print-break">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">Grafos</span>
                  </div>
              ...
              <section className="mb-12 print-break">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">Matrizes</span>
                  </div>
                    ...
                    <div className="space-y-6">
                          ...
                          <table className="mx-auto text-sm font-mono border-collapse">
                            <thead>
                              <tr>
                                ...
                                <th className="border-2 border-gray-400 px-4 py-2 bg-green-100">1</th>
                                <th className="border-2 border-gray-400 px-4 py-2 bg-green-100">2</th>
                                <th className="border-2 border-gray-400 px-4 py-2 bg-green-100">3</th>
                                <th className="border-2 border-gray-400 px-4 py-2 bg-green-100">4</th>
                              </tr>
                            </thead>
                            <tbody>
                              <tr>
                                <td className="border-2 border-gray-400 px-4 py-2 bg-green-100 font-bold">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                              </tr>
                              <tr>
                                <td className="border-2 border-gray-400 px-4 py-2 bg-green-100 font-bold">2</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                              ...
                              <tr>
                                <td className="border-2 border-gray-400 px-4 py-2 bg-green-100 font-bold">3</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                              ...
                              <tr>
                                <td className="border-2 border-gray-400 px-4 py-2 bg-green-100 font-bold">4</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center bg-yellow-100">1</td>
                                <td className="border-2 border-gray-400 px-4 py-2 text-center">0</td>
                      ...
                      <div>
                        ...
                        <div className="bg-white p-4 rounded-lg space-y-2 text-sm">
                          ...
                          <p className="mt-3 text-gray-600">Todos os outros elementos = 0</p>
                        </div>
                      </div>
              ...
              <section className="mb-12 print-break">
                <div className="bg-white p-6 rounded-lg shadow-md">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <span className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm">Caminhos</span>
                  </div>
