...
export default function ShareButtons({ title }: ShareButtonsProps) {
  ...
  const shareOnTwitter = () => {
    const text = `Estudando ${title} - Teoria dos Grafos`
    window.open(
  ...
  return (
    <div className="relative print:hidden">
      <button
        ...
        className="fixed bottom-56 right-8 p-4 bg-blue-600 hover:bg-blue-700 text-white rounded-full shadow-lg hover:shadow-xl transition-all z-40 group"
      ...
      {showMenu && (
        <div className="fixed bottom-72 right-8 bg-white dark:bg-gray-800 rounded-lg shadow-xl p-4 z-50 border border-gray-200 dark:border-gray-700">
