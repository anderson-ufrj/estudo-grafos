        ...
        <main className="container-modern px-4 py-8">
          <div className="max-w-5xl mx-auto">
            <nav className="mb-8">
              ...
              <span className="mx-2 text-gray-500">/</span>
              <span className="text-gray-900">Fórmulas Essenciais</span>
            </nav>

            <h1 className="text-4xl font-bold mb-4">Fórmulas Essenciais</h1>
            <p className="text-gray-600 mb-8">Todas as fórmulas importantes de Teoria dos Grafos em um só lugar</p>
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Conjunto Potência</p>
                    <p className="text-lg">|P(A)| = 2<sup>|A|</sup></p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Produto Cartesiano</p>
                    <p className="text-lg">|A × B| = |A| · |B|</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">União</p>
                    <p className="text-lg">A ∪ B = {'{x | x ∈ A ou x ∈ B}'}</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Interseção</p>
                    <p className="text-lg">A ∩ B = {'{x | x ∈ A e x ∈ B}'}</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Diferença</p>
                    <p className="text-lg">A - B = {'{x | x ∈ A e x ∉ B}'}</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Complemento</p>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Grafo</p>
                    <p className="text-lg">G = (V, E)</p>
                    <p className="text-xs text-gray-500 mt-1">V = vértices, E = arestas</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Grau de um Vértice</p>
                    <p className="text-lg">deg(v) ou d(v)</p>
                    <p className="text-xs text-gray-500 mt-1">número de arestas incidentes</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Arestas em Grafo Completo</p>
                    <p className="text-lg">|E| = n(n-1)/2</p>
                    <p className="text-xs text-gray-500 mt-1">K<sub>n</sub> tem n vértices</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Arestas em Árvore</p>
                    <p className="text-lg">|E| = |V| - 1</p>
                    <p className="text-xs text-gray-500 mt-1">grafo acíclico conexo</p>
                  </div>
                </div>
                ...
                <div className="mt-6 theorem-box">
                  ...
                  <div className="bg-white p-4 rounded-lg">
                    ...
                    <p className="text-center text-sm text-gray-600">v ∈ V</p>
                  </div>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Comprimento do Caminho</p>
                    <p className="text-lg">ℓ(P) = número de arestas</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Distância</p>
                    <p className="text-lg">d(u,v)</p>
                    <p className="text-xs text-gray-500 mt-1">comprimento do menor caminho</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Diâmetro</p>
                    <p className="text-lg">diam(G) = max d(u,v)</p>
                    <p className="text-xs text-gray-500 mt-1">maior distância no grafo</p>
                  </div>

                  <div className="formula-box">
                    <p className="text-xs text-gray-600 mb-2">Raio</p>
                    <p className="text-lg">rad(G) = min<sub>v</sub> max<sub>u</sub> d(u,v)</p>
                    <p className="text-xs text-gray-500 mt-1">excentricidade mínima</p>
                  </div>
                </div>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Todo par de vértices conectado</p>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Grafo em forma de círculo</p>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Grafo acíclico conexo</p>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">V₁ ∩ V₂ = ∅</p>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Todos vértices mesmo grau</p>
                  </div>
                  ...
                  <div className="bg-white p-5 rounded-lg shadow-sm">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Pode ser desenhado sem cruzamentos</p>
                  </div>
                </div>
              </section>
